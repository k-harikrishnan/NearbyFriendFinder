...
public class Joinedgroup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joinedgroup);
        listv=(ListView)findViewById(R.id.list1);
        PostToServer();
    }
    private void PostToServer() {
        nameValuePairs = new ArrayList<NameValuePair>();
        nameValuePairs.add(new BasicNameValuePair("tag", "ListJoined"));
    ...
    public class BackTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            CustomListAdapter cus=new CustomListAdapter(Joinedgroup.this,data);
